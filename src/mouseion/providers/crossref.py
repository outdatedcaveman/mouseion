...
class CrossRefProvider(BaseProvider):
    ...
    _max_concurrent = 5
    _min_interval = 0.15  # ~6 req/s — polite pool is generous but not infinite
    ...
    def __init__(self, email: Optional[str] = None) -> None:
        ...
        if not email:
            try:
                ...
                cfg = get_config()
                email = email or cfg.crossref_email or cfg.openalex_email
            except Exception:
                pass
    ...
    async def search(
        ...
        params: dict = {
            ...
            "select": (
                ...
                "publisher,ISSN,issn-type,ISBN,URL,license,subject,"
