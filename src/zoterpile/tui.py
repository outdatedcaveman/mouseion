"""
zoterpile TUI — Terminal User Interface

A keyboard-driven reference manager built with Textual.

Launch
------
    zoterpile gui           # after pip install
    python -m zoterpile.tui # dev / no-install

Layout
------
  ┌─────────────────────────────────────────────────────────────┐
  │  zoterpile                              12:34        Help   │
  ├─────────────────────────────────────────────────────────────┤
...
class ZoterpileApp(App):
    """Zoterpile — keyboard-driven reference manager."""
...
def run() -> None:
    """Launch the TUI. Called by `zoterpile gui` and the `zoterpile-gui` script."""
    ZoterpileApp().run()
