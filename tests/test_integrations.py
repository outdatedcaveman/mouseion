...
class TestZoteroIntegration:
    ...
    def integration(self, tmp_path, monkeypatch):
        ...
        from zoterpile.integrations.zotero import ZoteroIntegration
    ...
    def test_ref_to_zotero_item_type(self):
        from zoterpile.integrations.zotero import _ref_to_zotero_item
...
class TestNotionIntegration:
    ...
    def integration(self, monkeypatch):
        ...
        monkeypatch.setattr(cfg_mod, "get_config", lambda: fake_cfg)
        from zoterpile.integrations.notion import NotionIntegration
    ...
    def test_ref_to_notion_properties_title(self):
        from zoterpile.integrations.notion import _ref_to_notion_properties
    ...
    def test_ref_to_notion_blocks_abstract(self):
        from zoterpile.integrations.notion import _ref_to_notion_blocks
...
class TestObsidianIntegration:
    ...
    def integration(self, vault):
        from zoterpile.integrations.obsidian import ObsidianIntegration
...
class TestInstapaperIntegration:
    ...
    def integration(self):
        from zoterpile.integrations.instapaper import InstapaperIntegration
    ...
    def test_best_url_prefers_doi(self):
        from zoterpile.integrations.instapaper import _best_url
